...
angular.module('newsletterEditorApp')
  .directive('positionBtn', function() {
    return {
      template:
      '<div id="container-for-draggable" style="background: #e3e3e3; height: 100px; width: 150px;"> ' +
        '<span id="btn-movable" class="btn btn-default" draggable containment="parent">' +
      ...
      link: function(scope, element, attrs) {
        element.find('span').bind('dragstop', function() {
          ...
          scope.onChange(this, scope.$parent.position);
        });
      }
    };
  });
